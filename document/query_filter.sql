...
(
    ...
    from_parameter_sub_query_id int(10) unsigned NOT NULL DEFAULT '0' COMMENT '开始子查询',
    ...
    to_parameter_sub_query_id   int(10) unsigned NOT NULL DEFAULT '0' COMMENT '结束子查询',
