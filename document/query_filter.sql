...
(
    ...
    parameter_sub_query_id   int(10) unsigned NOT NULL DEFAULT '0' COMMENT '子查询主键',
    parameter_sub_query_name varchar(64)      NOT NULL DEFAULT '' COMMENT '子查询名',
...
(
    ...
    from_sub_query_id      int(10) unsigned NOT NULL DEFAULT '0' COMMENT '开始子查询主键',
    from_sub_query_name    varchar(64)      NOT NULL DEFAULT '' COMMENT '开始子查询名',
    ...
    to_sub_query_id        int(10) unsigned NOT NULL DEFAULT '0' COMMENT '结束子查询主键',
    to_sub_query_name      varchar(64)      NOT NULL DEFAULT '' COMMENT '结束子查询名',
