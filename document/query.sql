...
(
    ...
    from_sub_query_id   int(10) unsigned NOT NULL DEFAULT '0' COMMENT '子查询',
    from_sub_query_name varchar(64)      NOT NULL DEFAULT '' COMMENT '子查询别名',
    page_type           int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分页方式',
    page_size           int(10) unsigned NOT NULL DEFAULT '0' COMMENT '每页行数',
