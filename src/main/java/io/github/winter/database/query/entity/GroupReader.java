...
public class GroupReader {
    ...
    public List<Entity.Group> read(@NotNull Template template, int queryId) throws SQLException {
        ...
        List<Entity.Group> result = new ArrayList<>();
        ...
        for (Map<String, Value> valueMap : list) {
            ...
            Entity.Group record = new Entity.Group();
