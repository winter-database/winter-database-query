 ...
 */
public class FilterNullReader {

    public Entity.FilterNull read(@NotNull Template template, int queryId, int filterId) throws SQLException {
        ...
        Map<String, Value> valueMap = template.selectOne("xquery_filter_null", filters, null, null);

        Value isNot = valueMap.get("is_not");

        Entity.FilterNull result = new Entity.FilterNull();
