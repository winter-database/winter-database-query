...
public final class QueryFilterWildcardDto implements Serializable {
     ...
     * 表名
     */
    public static final String TABLE_NAME = "xquery_filter_wildcard";
     ...
     */
    public static List<QueryFilterWildcardDto> readInstances(@NotNull Template template, int queryId, int filterId) {
     ...
     * @return [ the {@link QueryFilterWildcardDto} instance ]
     */
    public static List<QueryFilterWildcardDto> newInstances(List<Map<String, Value>> list) {
        if (list != null) {
            return list.stream()
